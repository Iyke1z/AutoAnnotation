python3 -m experiments.glocal_analysis --model_name yolov5_nc7_attention --dataset_name coco2017 --batch_size 13
...
python3 -m experiments.explanation_complexity --model_name yolov5_nc7_attention --dataset_name coco2017
...
python3 -m experiments.plot_instance_perturbation --model_name yolov5_nc7_attention --dataset_name coco2017 --insertion False
#
# python3 -m experiments.plot_instance_perturbation --model_name yolov6 --dataset_name coco2017 --insertion True
python3 -m experiments.plot_instance_perturbation --model_name yolov5_nc7_attention --dataset_name coco2017 --insertion True
...
do
  for l in "${LAYER[@]}"
  do
    python3 -m experiments.concept_backgroundiness --model_name yolov5_nc7_attention --dataset_name coco2017 --layer_name $l --class_id $s
    python3 -m experiments.concept_backgroundiness_evaluation --model_name yolov5_nc7_attention --dataset_name coco2017 --layer_name $l --class_id $s
  done
done
