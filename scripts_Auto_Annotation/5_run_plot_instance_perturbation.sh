...
python3 -m experiments.plot_instance_perturbation --model_name yolov5_nc7_with_semi_supervision --dataset_name coco2017 --insertion False
#
# python3 -m experiments.plot_instance_perturbation --model_name yolov6 --dataset_name coco2017 --insertion True
python3 -m experiments.plot_instance_perturbation --model_name yolov5_nc7_with_semi_supervision --dataset_name coco2017 --insertion True