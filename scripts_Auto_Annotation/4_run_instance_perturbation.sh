...
for l in "${LAYERS[@]}"
do
  python3 -m experiments.instance_perturbation_od --model_name yolov5_nc7_with_semi_supervision --dataset_name coco2017 --layer_name $l --num_samples 100 --batch_size 20 --insertion False
  python3 -m experiments.instance_perturbation_od --model_name yolov5_nc7_with_semi_supervision --dataset_name coco2017 --layer_name $l --num_samples 100 --batch_size 20 --insertion True
done
