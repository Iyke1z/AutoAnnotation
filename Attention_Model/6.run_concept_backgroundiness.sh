...
#  for l in "${LAYER[@]}"
#  do
#    python3 -m experiments.concept_backgroundiness --model_name yolov5_nc_attention7 --dataset_name coco2017 --layer_name $l --class_id $s --batch_size 7
#    python3 -m experiments.concept_backgroundiness_evaluation --model_name yolov5_nc_attention7 --dataset_name coco2017 --layer_name $l --class_id $s
#  done
#done
#
